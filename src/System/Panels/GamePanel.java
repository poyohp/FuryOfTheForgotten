...
public class GamePanel extends JPanel implements Runnable{
    ...
    public GamePanel() {
        ...
        snail = new EternalSnail(100, 0.5, Tile.tileSize, Tile.tileSize, "Snail", Tile.tileSize * 2, Tile.tileSize * 23, Tile.tileRatio,5*Tile.tileRatio, 70, 50, player, levelHandler.getCurrentLevel().getMap().baseLayerTiles, true);
